...
* To train the model on MNIST, run:
   ...
   ```
* Additionally, check out the [jax_mnist_diffusion_transformer.ipynb](https://nbviewer.org/urls/huggingface.co/vachanvy/Diffusion_Transformer/resolve/main/jax_mnist_diffussion_transformer.ipynb) notebook for a JAX version of the model:
